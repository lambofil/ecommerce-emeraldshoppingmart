    ...
    <div className="grid lg:grid-cols-2 gap-5 bg-white p-4 rounded-lg">
      ...
      <div className="flex flex-col justify-center gap-y-10">
        ...
        <div className="flex items-center cursor-pointer group">
          <button onClick={() => dispatch(addToCart(product)) && toast.success(`${product?.title.substring(0, 15)} added successfully`) }className="bg-darkText text-slate-100 px-6 py-3 text-sm uppercase flex items-center border-r-[1px] border-r-slate-500">
            add to cart
          </button>
        ...
        <p className="flex item-center gsp-x-2 text-sm">
